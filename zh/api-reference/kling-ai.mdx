...
| 参数 | 类型 | 默认值 | 说明 |
|------|------|--------|------|
| `model_name` | string | kling-v1 | 模型版本：`kling-v1` / `kling-v1-5` / `kling-v1-6` / `kling-v2-master` / `kling-v2-1` / `kling-v2-1-master` / `kling-v2-5-turbo` |
...
- `kling-v2-master`、`kling-v2-1`、`kling-v2-1-master`、`kling-v2-5-turbo`：高质量版本，推荐使用
