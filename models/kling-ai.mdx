...
- **Breaking change (2025-12-19)**: Added `text-to-video` type support; added `sound` parameter (V2.6 only, enables audio generation); added `aspect_ratio` parameter (V2.6 only: 16:9, 9:16, 1:1); added `kling-v2-6` model version.
...
| `kling-v2-6` | **Latest version**, supports sound and aspect_ratio |
...
- **Does Kling V2.6 support text-to-video?** Yes, V2.6 supports both `text-to-video` and `image-to-video`.
